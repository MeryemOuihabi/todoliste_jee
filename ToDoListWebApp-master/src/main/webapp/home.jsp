    ...
    <ul id="task-list">
        ...
        <li>
            ...
            <form method="post" action="">
                ...
                <input type="submit" class="edit-task" name="action" value="Edit">
...
<%
    ...
    if (editTaskClicked != null && taskDescriptionToEdit != null && newTaskDescription != null) {
        try {
            String hostname = "localhost";
            String port = "3306";
            String usern = "root";
            ...
            String connectionUrl = String.format("jdbc:mysql://%s:%s/%s?useSSL=false", hostname, port, schema);
            Connection connection = DriverManager.getConnection(connectionUrl, usern, password);
            String updateSql = "UPDATE tasks SET task = ? WHERE task = ?";
            PreparedStatement updateStatement = connection.prepareStatement(updateSql);
            updateStatement.setString(1, newTaskDescription);
            updateStatement.setString(2, taskDescriptionToEdit);
            ...
            // Reload the page after modification
            response.sendRedirect(request.getRequestURI());
        } catch (SQLException | ClassNotFoundException e) {
            e.printStackTrace();
        }
